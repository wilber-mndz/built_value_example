...
const Colors _$blue = const Colors._('blue');
const Colors _$red = const Colors._('red');

Colors _$enumNamecolorsValueOf(String name) {
  switch (name) {
    case 'blue':
      return _$blue;
    case 'red':
...
final BuiltSet<Colors> _$enumNamecolorsValues =
    new BuiltSet<Colors>(const <Colors>[
  _$blue,
  _$red,
]);
